...
fn main(@builtin(global_invocation_id) id: vec3u) {
    ...
    let forwards: vec3<f32> = vec3<f32>(1.0, 0.0, 0.0); //scene.cameraForwards;
    let right: vec3<f32> = vec3<f32>(0.0, -1.0, 0.0); //scene.cameraRight;
    let up: vec3<f32> = vec3<f32>(0.0, 0.0, 1.0); //scene.cameraUp;
    ...
    var myRay: Ray;
    myRay.origin = vec3<f32>(-3.0, 0.0, 0.0); //scene.cameraPos;
